...
if colortype == "colorama":
    ...
    newps1 = colorama.Style.BRIGHT + colorama.Fore.GREEN + \
        pv + " >>> " + colorama.Style.RESET_ALL
    newps2 = colorama.Style.BRIGHT + colorama.Fore.GREEN + \
    ...
    term_with_colors = ['xterm', 'xterm-color', 'xterm-256color',
