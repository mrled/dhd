...
# Colorize the prompt where possible.
# Tries to use colorama. If not installed:
# Unix falls back to ANSI escapes
# Windows falls back to black & white
# (On Windows you can natively set fg/bg color for whole terminal, but not individual characters)
...
try:
    ...
    if os.name is "posix":
        ...
        raise Exception ("Your OS is reported to be " + os.name + " but we don't know how to colorize it.")

vt = platform.python_version_tuple()
pv = "ipy" + vt[0] + "." + vt[1] # ignore minor releases: py3.2 instead of py3.2.3
...
c.PromptManager.in_template = newps1
c.PromptManager.in2_template = newps2
...
# c.TerminalIPythonApp.ipython_dir = '/home/mrled/.config/ipython'
...
# c.TerminalInteractiveShell.banner1 = 'Python 3.2.3 (default, Apr 12 2012, 21:55:50) \nType "copyright", "credits" or "license" for more information.\n\nIPython 0.12.1 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
